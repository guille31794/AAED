...
class Binario
{
  public:
    ...
    friend Binario operator ~(const Binario& B) noexcept;
    friend Binario operator &(const Binario& B1, const Binario& B2) noexcept;
    friend Binario operator |(const Binario& B1, const Binario& B2) noexcept;
    friend Binario operator ^(const Binario& B1, const Binario& B2) noexcept;
    friend void operator <<(Binario& B, const unsigned n) noexcept;
    friend void operator >>(Binario& B, const unsigned n) noexcept;
...
Binario operator ~(const Binario& B) noexcept
{
  Binario Bin(B);
...
Binario operator &(const Binario& B1, const Binario& B2) noexcept
{
  Binario Bin("");
...
void operator <<(Binario& B, const unsigned n) noexcept
{
